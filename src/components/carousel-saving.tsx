...
export function CarouselSaving() {
  ...
  return (
    <div
      className="relative rounded-[10px] h-[500px] mt-4 w-full flex flex-col items-center justify-center">
      <div
        ...
        <div className="opacity-50">MM003</div>
      </div>
      ...
      <Carousel plugins={[
        ...
        <CarouselContent className='w-full ml-0'>
          <CarouselItem className="w-full flex flex-col items-center justify-between gap-16">
            <div className="">
              <Image
                src="https://cdn.prod.website-files.com/652dbebd0c8e37e771b32d9c/652ea7f0db8e2313f695124e_SavingRoundUps.png"
            ...
            <div className='flex flex-col items-center'>
              <p className="font-normal text-sm max-w-[300px] text-center">
                Round up to the nearest dollar and save every time you spend.
              </p>
            </div>
          </CarouselItem>
          <CarouselItem className="w-full flex flex-col items-center justify-between gap-10">
            <div className="">
              <Image
                src="https://cdn.prod.website-files.com/652dbebd0c8e37e771b32d9c/652ea7f057e2dfdd4214f231_SavingSteps.png"
                alt="A box with news about Microsoft stock and United Airlines stock"
                width={500}
                height={400}
                className="w-[179px]"
